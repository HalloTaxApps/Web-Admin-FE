...
const TableAdvertisements = () => {
    return (
        <PageLayout>
            <table className='tableadvertisements'>
                        ...
                        <tr>
                            ...
                            <td>https://www.tokopedia.com/</td>
                            {
                                <td className='flex'>
                                    ...
                                    <button className='inline-block align-middle text-center select-none border font-normal whitespace-no-wrap rounded py-1 px-3 leading-normal no-underline bg-red-600 text-white hover:bg-red-700' href='/editAdvertisements'>Delete</button>
                                </td>
                            }
                        </tr>
                    </tbody>
...
export default TableAdvertisements